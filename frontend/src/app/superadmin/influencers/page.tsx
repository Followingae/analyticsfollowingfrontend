            ...
            <div className="@container/main flex flex-1 flex-col gap-6 p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">Manage influencer database and analytics</p>
                </div>
              </div>

              <div className="text-center py-12">
                <h3 className="text-lg font-semibold mb-2">Influencer Management</h3>
                <p className="text-muted-foreground">
                  Influencer database management coming soon...
                </p>
              </div>
            </div>
          </div>
