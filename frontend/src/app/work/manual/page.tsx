...
const DESKS = [
  ...
  { who: 'Aqsa', role: 'Talent',
    sees: 'Added today against your target · rates to get · creators you’re chasing · rosters short',
...
const SLIDES: Slide[] = [
...

  {
    ...
    where: [{ label: 'Brands', href: '/work/brands' }, { label: 'Packs', href: '/work/areas?kind=sample' }],
    helps: [
      'Logging the brand is what asks a founder to open the roster, so you do not have to chase anyone for it.',
    ...
    handover: 'It lands on the founders’ Today as “Start sourcing”, with the brand beside it, and turns urgent after three days.',
  },
  {
    id: 'area', kind: 'stop', who: 'Hajar or Zain', role: 'Founder', icon: Layers,
    title: 'The founder opens the roster',
    lede: 'A roster is one brand’s working list: the brief, an owner, a number and a date. It is the only place creators are gathered for that brand.',
    does: [
      'Write the brief in fields, not prose: categories, market, follower band, deliverables, and the budget the client told us they have.',
      'Give it a number and a date, and name who is stocking it.',
      'One roster per brand. It grows over months instead of being rebuilt per campaign.',
    ],
    where: [{ label: 'Rosters', href: '/work/areas' }],
    helps: [
      'One roster per brand keeps everything in one place, so nothing is researched twice.',
  ...
  },
  {
    ...
    handover: 'Approving starts their analytics, the first money we spend on them, and drops them back onto the brand’s roster.',
  },
  {
    ...
    does: [
      'Open the roster and tick who may leave the building.',
