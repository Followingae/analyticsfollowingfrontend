...
export const COLUMN_DEFINITIONS: ColumnDefinition[] = [
  ...
  { key: 'ig_reel_cost', label: 'Reel Cost', defaultVisible: true, sortable: false },
  { key: 'ig_reel_sell', label: 'Reel Sell', defaultVisible: true, sortable: false },
  { key: 'ig_post_cost', label: 'Post Cost', defaultVisible: false, sortable: false },
  { key: 'ig_post_sell', label: 'Post Sell', defaultVisible: false, sortable: false },
...
export function formatCents(cents: number | null): string {
  ...
  return `AED ${(cents / 100).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`
}
