...
const OPERATOR_NAV: (CmdEntry & { module?: string })[] = [
  ...
  { title: "Who has gone quiet", href: "/work/brands", icon: Activity,
    module: "clients", keywords: "brands heartbeat silent quiet last contact whose move" },
  { title: "My team", href: "/work/team", icon: Users,
    keywords: "approvals alerts people cofounder" },
  { title: "Daily targets", href: "/work/goals", icon: Target,
    keywords: "goals targets pace monthly rules daily" },
  ...
  { title: "Where we're thin", href: "/work/coverage", icon: Database,
    module: "influencers", keywords: "coverage gaps research backlog category market" },
...
const OPERATOR_ACTIONS: (CmdEntry & { module?: string })[] = [
  ...
  { title: "Start sourcing for a brand", href: "/work/areas", icon: Plus, module: "influencers" },
