...
export const WALKTHROUGHS: Walkthrough[] = [
  ...
  // ───────────────────────────────────────────────────────────── Sourcing
  {
    ...
    steps: [
      ...
      { title: 'Read the criteria first', target: '[data-tour="page-head"]',
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'The criteria sit above the creators', target: '[data-tour="page-head"]',
