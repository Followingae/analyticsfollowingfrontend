...
export const WALKTHROUGHS: Walkthrough[] = [
  ...
  // ───────────────────────────────────────────────────────────── Start here
  {
    ...
    steps: [
      { goto: '/work/today', target: '[data-tour="today-greeting"]', place: 'bottom',
        ...
        body: 'Open it first each morning. Everything below is either waiting on you or running without you.' },
      ...
      { target: '[data-tour="today-queue"]', place: 'right',
        title: 'Two lists',
        body: 'Waiting on you needs something from you. Running without you is moving and needs nobody.' },
      ...
      { target: '[data-tour="shortcut-areas"]', place: 'bottom', onlyIfPresent: true,
        title: 'Brand rosters',
        body: 'Use this to open a brand\u2019s roster and add creators to it.' },
      ...
      { target: '[data-tour="shortcut-approvals"]', place: 'bottom', onlyIfPresent: true,
        title: 'Sign-offs',
        body: 'Use this to see what was asked of a founder, and whether they have answered.' },
      ...
      { target: '[data-tour="shortcut-coverage"]', place: 'bottom', onlyIfPresent: true,
        ...
        body: 'Use this to see which categories and markets we are short on, so you know who to find next.' },
  ...
  },
  {
    ...
    blurb: 'A short menu, and one search box.',
    steps: [
      { title: 'Two minutes',
        body: 'A few short stops. Stop whenever you like and start again from the same button.' },
      { target: '[data-sidebar="sidebar"]', place: 'right',
        title: 'Your menu is your job',
        body: 'Today, then the few screens your own work needs. Named after the job, not the department.' },
      ...
      { title: 'A dash means nothing recorded',
        body: 'Where a figure shows a dash, there is nothing to show you there yet.' },
      { target: '[data-tour="help"]', place: 'bottom',
        title: 'This button',
  ...
  },
  {
    ...
    blurb: 'Today and Waiting on me. What to do, and what is stuck.',
    steps: [
      ...
      { goto: '/work/inbox', title: 'Waiting on me',
  ...
  },
  {
    ...
    title: 'Sharing work with a client',
    blurb: 'The tidy way to show a client what we have.',
    steps: [
      { title: 'Work freely',
        body: 'Anything on your screen is yours to work with. That is the job.' },
      { title: 'Send a link, not a file',
        body: 'A link stays current and can be updated. A file is out of date the moment you send it.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { target: '[data-tour="start-sourcing"]', place: 'left', title: 'Start sourcing',
        body: 'Pick the brand and write what we are looking for. You are not asked who does it.' },
      ...
      { title: 'Then talent is told',
        body: 'The talent team gets it at once, with the brief attached, and the brand opens for them. The area says who logged it, who released it and who it went to.' },
    ],
  },
  {
