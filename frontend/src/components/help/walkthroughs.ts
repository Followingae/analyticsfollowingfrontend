...
export const WALKTHROUGHS: Walkthrough[] = [
  ...
  },
  {
    ...
    steps: [
      { goto: '/work/influencers', title: 'Why this half matters',
        body: 'A handle on its own is a name. A handle with a rate is something we can sell.' },
      { title: 'Open the creator',
        body: 'Click their row. A panel opens on the right.' },
      { title: 'Go to Pricing',
        body: 'Fill in reel and post first. We quote those two most. The others sit under More.' },
      { title: 'Say who quoted it, and when',
        body: 'Anything older than six months should be checked again before we use it.' },
      { title: 'Add the manager or agency',
        body: 'So nobody has to find out again next quarter who to email.' },
      { title: 'Cost is not what we charge',
        body: 'You record what they charge us. A founder sets what the client pays, and you will not see it.' },
  ...
  },
  {
    ...
    steps: [
      { goto: '/work/influencers/review', title: 'The Waiting room',
        body: 'Everyone we cannot quote yet. New finds, and anyone still missing a price.' },
      { title: 'Each card says why it is there',
        body: 'New and needs a decision, cost known but no price yet, or nothing at all.' },
