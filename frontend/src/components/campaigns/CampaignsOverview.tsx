            ...
            <div className="@container/main flex flex-1 flex-col gap-6 p-4 md:p-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">Manage your marketing campaigns with Instagram post analytics</p>
                </div>
                ...
                <div className="flex justify-center py-12">
                  <EmptyState
                    ...
                    description={searchQuery.trim() || statusFilter !== 'all' || typeFilter !== 'all' || priorityFilter !== 'all'
                      ...
                      : 'Create your first campaign to start tracking\nyour marketing performance and Instagram post analytics.'
                    }
                    icons={[Target, BarChart3, Instagram]}
