...
const PATHS = [
  '/', '/checkout', '/checkout-everywhere', '/checkout-os', '/intelligentcheckout',
  '/ecommerce', '/enterprise', '/payments', '/connect', '/pay', '/network',
  '/bolt-id', '/fraud', '/security', '/high-risk', '/saas', '/subscriptions',
  '/digital-goods', '/stablecoins', '/startups', '/app-devs', '/shopper-trust-toolkit',
  '/pricing', '/our-story', '/careers', '/case-studies', '/resources', '/blog',
  '/news', '/faq', '/contact-sales', '/contact-us', '/get-started', '/activate',
  '/install', '/refer', '/media-kit', '/shop', '/check-in',
  '/privacy', '/privacy-center', '/terms-of-use', '/end-user-terms', '/checkout-demo',
];
